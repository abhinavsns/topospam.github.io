...
<div class="row justify-content-center">
  <div class="col-md-4 text-center">
    <a href="https://www.mpi-cbg.de/research/researchgroups/currentgroups/ivo-sbalzarini/group-leader" target="_blank">
      <img src="{{ site.baseurl }}/assets/images/team/ivo.jpg" alt="Ivo Sbalzarini" class="img-fluid rounded-circle mb-3" width="200">
    </a>
    <h5>Ivo Sbalzarini</h5>
  </div>
  <div class="col-md-4 text-center">
  ...
  <div class="col-md-4 text-center">
    <a href="https://www.mpi-cbg.de/research/researchgroups/currentgroups/carl-modes/group-leader" target="_blank">
      <img src="{{ site.baseurl }}/assets/images/team/carl.jpg" alt="Carl Modes" class="img-fluid rounded-circle mb-3" width="200">
    </a>
    <h5>Carl Modes</h5>
  </div>
</div>
...
<div class="row mt-5">
  <div class="col-md-4">
    <div class="row justify-content-center">
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/abhinav.jpg" alt="Abhinav" class="img-fluid rounded-circle mb-3" width="200">
        <p>Abhinav</p>
      </div>
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/philipp.jpg" alt="Philipp" class="img-fluid rounded-circle mb-3" width="200">
        <p>Philipp</p>
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/sachin.jpg" alt="Sachin" class="img-fluid rounded-circle mb-3" width="200">
        <p>Sachin</p>
      </div>
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/pietro.jpg" alt="Pietro" class="img-fluid rounded-circle mb-3" width="200">
        <p>Pietro</p>
      </div>
    </div>
  </div>
   <div class="col-md-4">
    <div class="row justify-content-center">
      ...
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/aboutaleb.jpg" alt="Aboutaleb" class="img-fluid rounded-circle mb-3" width="200">
        <p>Aboutaleb</p>
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/charlie.jpg" alt="Charlie" class="img-fluid rounded-circle mb-3" width="200">
        <p>Charlie</p>
      </div>
    </div>
  </div>
  <div class="col-md-4">
    <div class="row justify-content-center">
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/carlos.jpg" alt="Carlos" class="img-fluid rounded-circle mb-3" width="200">
        <p>Carlos</p>
      </div>
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/abhijith.jpg" alt="Abhijith" class="img-fluid rounded-circle mb-3" width="200">
        <p>Abhijith</p>
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/alicja.jpg" alt="Alicja" class="img-fluid rounded-circle mb-3" width="200">
        <p>Alicja</p>
      </div>
      <div class="col-md-6 text-center">
        <img src="{{ site.baseurl }}/assets/images/team/mohammadreza.jpg" alt="Mohammadreza" class="img-fluid rounded-circle mb-3" width="200">
        <p>Mohammadreza</p>
      </div>
    </div>
  </div>
